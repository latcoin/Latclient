/**
 * Latcoin default external currency list.
 *
 ...
 *
 * Important: LAT must be the first entry in this list.
 */
module.exports = [
  {value: 'LAT', name: 'LAT - Latcoins', order: 1},
  {value: 'USD', name: 'USD - US Dollar', order: 4},
  {value: 'EUR', name: 'EUR - Euro', order: 3},
  {value: 'BTC', name: 'BTC - Bitcoin', order: 2},
  {value: 'LTC', name: 'LTC - Litecoin', order: 6},

 ...
 *
 * - rp-dest-address - If set, allows Latcoin addresses as destinations.
  ...
  return {
    ...
    link: function (scope, elm, attr, ctrl) {
      ...
      var validator = function(value) {
        ...
        if ( (shortValue==="LAT") || webutil.findIssuer(scope.lines,shortValue)) 
        {
  ...
  return {
    ...
    link: function (scope, elm, attr, ctrl) {
      ...
      var validator = function(value) {
        ...
        // If LAT, ensure amount is less than 100 billion
        if (currency &&

        ...
        $id.login($scope.username, $scope.password, function (err, blob) {
          ...
          if (err) {
            ...
            if (err.name === "OldBlobError") {
              popup.confirm("Wallet Upgrade", "Latcoin is upgrading the wallet encryption format. After the upgrade, only Latcoin clients 0.2.24 or higher can access your wallet.<br><br>If you use other clients, please make sure they are upgraded to the current version.",
